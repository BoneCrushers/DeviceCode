...
class CH341():
    ...
    def write_byte_data(self, addr, off, byte):
        try:
            ...
            print(f"write_byte_data({addr},{off},{byte}): {err}")
    ...
    def read_byte_data(self, addr, off):
        ...
        try:
            ...
            print(f"read_byte_data({addr},{off}): {err}")
        return rval
    ...
    def write_i2c_block_data(self, addr, off, data):
        try:
            ...
            print(f"write_i2c_block_data({addr},{off},[{len(data)} bytes]): {err}")
    ...
    def read_i2c_block_data(self, addr, off, length):
        ...
        try:
            ...
            print(f"read_i2c_block_data({addr},{off},{length}): [write_addr] {err}")
        ...
        try:
            ...
            print(f"read_i2c_block_data({addr},{off},{length}): [read_bytes] {err}")
        return rval
